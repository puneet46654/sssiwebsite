...
function MudraBookDemoSection() {
    return (<section className="w-full py-16 md:py-20 lg:py-24 bg-[#F4F6F8] overflow-hidden font-sans flex justify-center">
      ...
      <div className="w-full max-w-[1440px] px-6 lg:px-10 flex justify-center">
        ...
        <motion.div className="relative w-full max-w-[1380px] rounded-[24px] lg:rounded-[40px] overflow-hidden shadow-lg flex flex-col justify-center items-start p-8 sm:p-12 md:p-16 lg:px-[100px] min-h-[400px] sm:min-h-[450px] md:min-h-[500px] lg:min-h-[716px]" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: false, amount: 0.2 }}>
          
          
          <div className="absolute inset-0 z-0 pointer-events-none">
            <Image src="/images/home/book-demo/image1.webp" alt="SSI Mantra Robotic Arm" fill className="object-cover object-center md:object-right" loading="lazy"/>
...
export default React.memo(MudraBookDemoSection);
